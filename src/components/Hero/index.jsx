...
const Hero = () => {
  ...
  <div className="container mx-auto flex px-5 py-4 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <p className="mb-8 leading-relaxed">Get ready to embark on an electrifying shopping spree like never before, as Ecommerce presents an incredible extravaganza of huge sales! 
